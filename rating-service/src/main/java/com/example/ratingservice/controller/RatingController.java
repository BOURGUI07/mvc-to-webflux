...
public class RatingController {
    ...
    public Mono<ResponseEntity<PaginatedRatingResponse>> getRatingsByCustomerId(
        ...
        return service.findByCustomerId(customerId,page)
    ...
    public Mono<ResponseEntity<PaginatedRatingResponse>> getRatingsByProductId(
        ...
        return service.findByProductId(productId,page)
                .map(ResponseEntity::ok);
    }

    @PostMapping
    public Mono<ResponseEntity<RatingResponse>> createRating(
            @RequestBody Mono<RatingCreationRequest> request
    ){
    ...
    public Mono<ResponseEntity<RatingResponse>> updateRating(
            ...
            @RequestBody Mono<RatingUpdateRequest> request
    ){
        return service.updateRating(ratingId,request)
                .map(ResponseEntity::ok);
    }
